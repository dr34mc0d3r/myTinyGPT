...
class TinyTransformer(nn.Module):
    ...
    def __init__(self, config: ModelConfig):
        ...
        # Weight sharing: tie the word embedding and the output head
        # This is common in transformers to reduce parameter count
    ...
    def get_num_params(self, non_embedding=True):
        ...
        The token embeddings would too, except due to the weight sharing strategy
        they are already part of the lm_head which we do count.
        """
...
if __name__ == "__main__":
    ...
    config = ModelConfig(vocab_size=100, n_layers=4, n_heads=4, n_embd=256, block_size=256)
